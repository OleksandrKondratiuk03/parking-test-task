...
@Component
public class CompactFeeCalculationStrategyImpl implements FeeCalculationStrategy {

    private static final double BASIC_FEE = 2.0;

    @Override
    public boolean supports(Type type) {
        return Type.COMPACT.equals(type);
    }
